# Generated by Django 5.1.7 on 2025-06-03 12:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'مشتری'), ('restaurant_owner', 'مدیر رستوران')], default='customer', max_length=60, verbose_name='نوع کاربر')),
                ('phone_number', models.CharField(max_length=11, unique=True, verbose_name='شماره همراه')),
                ('date_join', models.DateTimeField(auto_now_add=True, verbose_name='تاریخ ایجاد')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('owner_name', models.CharField(blank=True, max_length=350, null=True, verbose_name='نام مدیر')),
